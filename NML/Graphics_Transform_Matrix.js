 ...
 * @LastEditTime: 2022-11-01 01:36:09
...
// open * 2d 变换矩阵 * open
    ...
    class Matrix_2 extends Matrix{
         ...
         * @return {Matrix_2} 返回一个2x2矩阵
         */
        static create_Rotate__v(v,_out){
            var unit_v=Vector.is_Unit(v)?v:Vector.create_Normalization(v),
                s=unit_v[1];
            CONFIG.AXIS?0:s*=-1;
            if(_out){
                _out[0]=c;  _out[0]=s;
            ...
            return new Matrix([unit_v[0],s,-s,unit_v[0]]);
        }
