 ...
 * @param {List_Value} v1 向量1   
 * @param {List_Value} v2 向量2   
 * @returns {Number} 返回 v1 * v2   
   
### static cross(v1,v2)  向量外积 仅支持 3D 和 2D 向量   
 * @param {List_Value} v1 向量1   
 * @param {List_Value} v2 向量2   
 * @returns {Number|List_Value} 返回 v1 x v2   
 ...
 * @returns {Hand__Transform_3D_Matrix_Ctrl}   
